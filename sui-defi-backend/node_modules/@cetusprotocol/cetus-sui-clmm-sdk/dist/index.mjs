...
var ConfigModule = class {
  ...
  transformExtensions(coin, dataArray, transformExtensions = true) {
    ...
    for (const item of dataArray) {
      ...
      if (key === "labels") {
        try {
          const decodedValue = decodeURIComponent(Base642.decode(value));
          try {
